...
export type StatementLabels = {close: string; openImage: string; closeImage: string; hideToday: string; readFull: string; notice: string; date: string; notifications: string; notificationDescription: string; email: string};
