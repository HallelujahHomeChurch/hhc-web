...
| 3A | [Operations Task 8 source removal](2026-09-15-unified-authorization-operations-api.md) | `operations-api` + `azure-infra`, then `asset-api`, then `hhc-web-api` | Counted import and target readiness pass; the direct sync-window workload handoff is released and observed |
